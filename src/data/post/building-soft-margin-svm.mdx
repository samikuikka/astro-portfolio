...
In this post I go over the math behind SVM and who how to implement a soft margin SVM in Python using a quadratic solver.
...
Here's figure depicting the devision of the hyperplane and the data points closest to the hyperplane (also known as support vectors).
